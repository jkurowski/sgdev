            ...
            <div class="card-head container-fluid">
                <div class="row">
                    <div class="col-12 pl-0">
                        <h4 class="page-title"><i class="fe-home"></i><a href="{{route('admin.developro.index')}}">Inwestycje</a><span class="d-inline-flex ms-2 me-2">/</span>{{$investment->name}}<span class="d-inline-flex me-2 ms-2">-</span>Dodaj plan inwestycji</h4>
                    </div>
                </div>
            </div>
